...
const App: React.FC = () => {
  ...
  const handleStart = () => setAppState(AppState.SELECTION);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Something went wrong with the AI service. Please check your API Key or try again.");
      setAppState(AppState.INPUT_FORM);
    }
  };
            ...
            <div className="max-w-xl mx-auto w-full animate-fade-in">
              <div className="bg-white/5 backdrop-blur-lg border border-white/10 p-8 rounded-3xl shadow-2xl">
                ...
                <button 
                  ...
                  className="w-full text-center mt-4 text-sm text-gray-500 hover:text-white transition-colors"
                >
                  Back to Selection
                </button>
              </div>
